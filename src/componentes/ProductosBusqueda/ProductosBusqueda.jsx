...
const ProductList = () => {
  ...
  const [products] = useState([
    ...
    { id: 3, name: 'Filos Microblading x10 18U 0.18, 18U 0.25, 16 angulares', price: 3300 },
    { id: 4, name: 'Filos Microblading x50 18U 0.18, 18U 0.25, 16 angulares', price: 15000 },
    ...
    { id: 9909907, name: 'Cartuchos Dermapen', price: 1200},
    ...
    { id: 22, name: 'Descartador de agujas 2.2L', price: 4555 },
   
    { id: 23, name: 'Tinta Dynamic negra 1oz', price: 10500 },
    { id: 23, name: 'Pen Bronc Magic', price: 290000 },
    ...
    { id: 28, name: 'Cofias x100', price: 5900 },
  ...
  { id: 38, name: 'Anestesia TKTX NUMB', price: 6500 },
  { id: 399883198, name: 'Anestesia TKTX 99.9%', price: 4900 },
  { id: 39, name: 'Anestesia TKTX Spray', price: 4000 },
  { id: 789539, name: 'Crema Tattoo Care 250ml', price: 6500 },
  { id: 365319, name: 'Jabon Tattoo Care 250ml', price: 6500 },
  ...
  { id: 49, name: 'Pen Rocket 2', price: 93000 },
  { id: 50, name: 'Pen Soulnova E2', price: 230000 },
  { id: 399800001, name: 'Pen Tattoo VENUS ', price: 230000 },
  { id: 51, name: 'Pen Carbon', price: 69000 },
  { id: 52, name: 'Fuente Nacional sin visor', price:  32900 },
  { id: 190, name: 'Fuente Inalmabrica AVA', price: 65700 },
...
{ id: 132320089, name: 'Sobres Tattoo Care x10 unidades dobles  ', price: 8000 },
...
{ id: 665600, name: 'Tinta 5 Jinetes', price: 4900 },
  ...
  { id: 697897110897893696, name: 'Caja Navajas x10', price: 1700 },
  ...
  { id: 59, name: 'PROMO SPARK CARTUCHOS X20 UNIDADES 1201, 1203, 1205', variants: ['1201', '1203', '1205'], price: 18388 },
  { id: 60, name: 'PROMO SPARK CARTUCHOS X20 UNIDADES 1207, 1209, 1211, 1214', variants: ['1207', '1209', '1211', '1214'], price: 20688 },
  { id: 61, name: 'PROMO SPARK CARTUCHOS X10 UNIDADES 1201, 1203, 1205, 1207, 1209, 1211, 1214', variants: ['1201', '1203', '1205', '1207', '1209', '1211', '1214'], price: 10235 },
  ...
  { id: 67, name: 'Cartuchos Dermografo Medidas 1R y 3R', variants: [], price: 1050 },
  { id: 68, name: 'Cartuchos Dermografo Medidas 5R', variants: [], price: 1050 },
